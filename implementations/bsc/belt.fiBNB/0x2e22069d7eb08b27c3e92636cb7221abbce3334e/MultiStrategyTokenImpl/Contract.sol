...
contract MultiStrategyTokenImpl is MultiStrategyTokenStorage {
    ...
    function updateStrategyList() public {
        require(msg.sender == govAddress || msg.sender == owner(), "!gov");
        removeStrategy(0xB8a8401d335B6c9FF6b56ae9ffE06342209b578F);
        removeStrategy(0xcaB590e347F18CC0809a2BAbFb9Dde429C518572);
        addStrategy(0x5142F6857f029BED5dDF6247D8a1f75984a3a380);
    }
