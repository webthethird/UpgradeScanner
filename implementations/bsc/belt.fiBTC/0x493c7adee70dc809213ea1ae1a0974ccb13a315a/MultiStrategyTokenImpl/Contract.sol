...
contract MultiStrategyTokenImpl is MultiStrategyTokenStorage {
    ...
    function updateStrategyList() public {
        require(msg.sender == govAddress || msg.sender == owner(), "!gov");
        removeStrategy(0x40F04D6c3a7e2B7217B45bDfbCdBA49487f15E72);
        removeStrategy(0x2Fa1C30a70c539bde3081345555EF2C3e83F1Ca1);
        addStrategy(0x3bD71Fd8633aE42c2496C6BdF9Dcb141157e6492);
        addStrategy(0xcb3346AD40C947A2228b2E224C3931A5224bA7Ad);
    }
