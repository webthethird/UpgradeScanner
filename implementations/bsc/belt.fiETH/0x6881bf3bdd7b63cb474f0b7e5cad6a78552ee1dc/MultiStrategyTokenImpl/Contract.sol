...
contract MultiStrategyTokenImpl is MultiStrategyTokenStorage {
    ...
    function updateStrategyList() public {
        require(msg.sender == govAddress || msg.sender == owner(), "!gov");
        removeStrategy(0x01783f31da1D589720030aBf6c62531c0e02e0c9);
        removeStrategy(0x9C1Fa07c7e1A0073A8AD30ede103c6c51bB62A0f);
        addStrategy(0x9A144edD7309bCc4e106A1a04E7Fc402115a0980);
    }
